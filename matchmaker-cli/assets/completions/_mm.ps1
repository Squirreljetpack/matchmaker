...
Register-ArgumentCompleter -Native -CommandName 'mm' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'mm' {
            ...
            [CompletionResult]::new('--download', '--download', [CompletionResultType]::ParameterName, 'Download all presets from GitHub. Use `--download=<FOLDER>` (no space) to download a subfolder')
