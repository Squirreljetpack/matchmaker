...
complete -c mm -l download -d 'Download all presets from GitHub, or a specific subfolder / preset file' -r
complete -c mm -l list -d 'Test a preset (see `mm --doc other`)' -r
