...
/// from `cc.max_cols`). For `Split::Delimiter` with unnamed capture groups,
/// and for `Split::Regexes`, the built names are truncated to the number of
/// capture groups / regexes respectively.
///
