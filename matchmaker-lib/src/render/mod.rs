...
mod test {
    ...
    fn layout_of(
        ...
        update_layout_and_state::<&'static str, (), NullActionExt>(
            area, state, picker, footer, preview, ui, None,
        )
    }
    ...
    fn render_ui_draws_outer_and_picker_borders() {
        ...
        terminal.draw(|frame| render_ui(frame, area, &ui)).unwrap();
