    ...
    for line in text.lines {
        ...
        for span in line.spans {
            ...
            while current_grapheme_start_idx < graphemes.len() {
                ...
                for (i, grapheme) in graphemes.iter().skip(current_grapheme_start_idx).enumerate() {
                ...
                if graphemes_in_chunk > 0 {
                    ...
                    let chunk_content = graphemes[current_grapheme_start_idx..chunk_end_idx].concat();
